...
intent_prompt = ChatPromptTemplate.from_messages(
    [
        ...
        (
            ...
            3a. If the user asks a question that requires calculation, computation, conversion,
            date/time lookup, web search, code execution, or another tool, classify it as
            "question" with needs_planner=true.

            3b. Do not treat a question as a direct-answer case merely because it is short
                or simple. If answering it reliably requires a tool, the planner should decide
                which tool to use.

            3c. Examples of questions requiring tools include:
                - "What is 1 + 2?"
                - "Calculate 25 * 48"
                - "Convert 10 USD to PKR"
